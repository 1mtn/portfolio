...
st.markdown("[Dataset on Kaggle](https://www.kaggle.com/datasets/kabhishm/countries-by-steel-production-19672021?select=steel_prod.csv )")
st.markdown("[See code on Github](https://github.com/1mtn/steelcountries)")

st.write("This is a list of countries by steel production in 1967, 1980, 1990, 2000 and from 2007 to 2021, based on data provided by the World Steel Association. All countries with annual production of crude steel at least 2 million metric tons. The data set has the production of steel in million metric tons by year and by country.")

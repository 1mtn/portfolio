...
st.markdown("[Kaggle Dataset](https://www.kaggle.com/datasets/spscientist/students-performance-in-exams/data)")
st.markdown("[See Code on Github](https://github.com/1mtn/students-scores)")
